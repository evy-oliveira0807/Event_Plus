...
import { transformDate } from "../../Utils/stringFuctions";
...
const EventosPage = () => {
  ...
  //função depara que guarda dentro do arrayOptions o tipo e titulo dos eventos para mandar para o select
  ...
  async function showUpdateForm(idElement) {
    ...
    try {
      ...
      setDataEvento(transformDate(retorno.data.dataEvento))
      console.log(retorno.data);
